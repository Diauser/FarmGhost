<?php
    ...
    $CodigoFinca = $_GET["cod_alf"];
    
    $sentencia = $dbh->prepare("SELECT * FROM vacuno WHERE cod_alf = ?;");
    ...
    <div class="modal-body">
        <form method="POST" action="EditarVacuno.php" style="width:40%; margin-top:40px; margin-left:470px; border-radius:20px; padding:35px; background-color:rgba(0,0,0,0.4);">
            ...
            <div>
                ...
                <input type="text" name="FechaIngreso" class="form-control" style="border: 3px solid #555;" value="<?php echo $Vacuno->FechaIngreso; ?>">
            </div>
            <br>
            <div>
                <label for="" style="color:white;">
